...
export class EditIngredientPage implements OnInit {
  ...
  //Récupérer l'ingrédient dans la liste en fonction du nom passé en paramètre dans l'url
  getIngredientByName(){
  ...
  //Créer le toast pour confirmer la supression des ingrédients
  ...
  //Créer le toast pour confirmer la modification de l'ingrédient
  ...
  //Créer le toast pour confirmer la suppression de l'ingrédient
