...
export class AddRecipePage implements OnInit {
  ...
  //Ajouter la recette dans la liste
  async onAddRecipe(){
    ...
    //Upload de la photo si différente de la toque
  ...
  //Toast pour indiquer l'ajout de la recette
  ...
  reinitializeForms(){
    ...
    this.peoplesFormControl.setValue('');    //recipe peoples
    this.peoplesFormControl.markAsUntouched();
  ...
  //Vérifie que l'unité choisi pour un ingrédient existe bien
