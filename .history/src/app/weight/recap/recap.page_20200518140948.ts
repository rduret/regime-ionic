...
export class RecapPage implements OnInit {
  ...
  constructor(private weightService: WeightService, private authService: AuthService, private route: ActivatedRoute) { }


  ngOnInit() {
    this.listMeasures = this.route.snapshot.data.measures;
    console.log(this.route.snapshot.data.measures)  
    this.getGoal();
